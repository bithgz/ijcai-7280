...
class Runner:
        ...
        while ep_count < self.args.n_eps:
            ...
            if ep_count > 5:
                ...
                for train_step in range(need_train_step):
                    ...
                    self.agents.train_critic_and_actor(mini_batch, train_step, target_update)
    ...
    #     rolloutWorker = RolloutWorker(port, self.args, no_graphics=False, time_scale = 1)
    #     rnn_para = self.agents.policy.get_para()
    #     win_rates = 0
    #     episode_rewards = 0
    #     ep_steps = 0
    #     for i in range(100):
    #         win_rate, episode_reward, ep_step = rolloutWorker.generate_episode_test(rnn_para)
    #         win_rates += win_rate
    #         episode_rewards += episode_reward
    #         ep_steps += ep_step
    #     print(  "testing ...... ep : ", eps, 
    #             " win_rate : ", win_rates / 100, 
    #             "  reward : ",episode_rewards / 100)
